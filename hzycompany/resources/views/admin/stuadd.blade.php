...
@section('content')
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">在这里添加新的学生账号</h1>
        <!-- end page-header -->
            ...
            <div class="col-md-6">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-stuff-4">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" action="{{url('/admin/stuaddt')}}" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                            ...
                            <fieldset>
                                ...
                                @if(Session::has('flash_success'))
                                    <div class="alert alert-success"><ul><li>{{ Session::get('flash_success') }}</li></ul></div>
                                @endif
